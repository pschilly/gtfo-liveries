...
-- ch-47f_tex16_DECAL
	{"ch-47f_tex16_DECAL", 0, "../19thHB/ch-47f_tex16",	false};
	{"ch-47f_tex16_DECAL", 1, "ch-47f_tex16_NRM",	true};
	{"ch-47f_tex16_DECAL", ROUGHNESS_METALLIC, "ch-47f_tex16_RoughMet", true};
	{"ch-47f_tex16_DECAL", DECAL, "ch-47f_decal",	false};
	
-- ch-47f_tex17
	{"ch-47f_tex17", 0, "../19thHB/ch-47f_tex17",	false};
	{"ch-47f_tex17", 1, "ch-47f_tex17_NRM",	true};
	{"ch-47f_tex17", ROUGHNESS_METALLIC, "ch-47f_tex17_RoughMet", true};

-- ch-47f_tex19
	{"ch-47f_tex19_dmg",	DIFFUSE			,	"ch-47f_tex19", false};
	{"ch-47f_tex19_dmg",	NORMAL_MAP			,	"ch-47f_tex19_nrm", true};
	{"ch-47f_tex19_dmg",	DAMAGE				,	"ch-47f_dmg_blade_main", true};
	{"ch-47f_tex19_dmg",	10,	"ch-47f_dmg_blade_nrm", true};
	-- Pilot
	{"Pilot_CH47_Helmet_Shell",	DIFFUSE			,	"../19thHB/pilot_ch47_helmet_shell", false};
	{"Pilot_CH47_Helmet_Shell",	NORMAL_MAP			,	"pilot_ch47_helmet_shell_normal", true};
	{"Pilot_CH47_Helmet_Shell",	SPECULAR			,	"pilot_ch47_helmet_shell_roughmet", true};
	
}

name = "GTFO - 19th Helicopter Brigade - CO"

custom_args =
{

[87] = 1.0, --pax door open
[349] = 1.0, --pilot door open

-- [31] = 1.0, -- Remove bort number
-- [32] = 1.0, -- Remove bort number
-- [442] = 1.0, --Remove bort number
}